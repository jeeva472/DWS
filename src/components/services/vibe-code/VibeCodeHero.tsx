...
import { ArrowRight, ChevronDown, Terminal, Cpu, ShieldCheck, Zap, Sparkles, CheckCircle2, Code2 } from "lucide-react";
import { ServicesHeroData } from "@/lib/types/wordpress";

interface VibeCodeHeroProps {
    ...
    <section className="relative min-h-[85vh] flex flex-col justify-center pt-32 sm:pt-40 pb-20 overflow-hidden bg-[#030608]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          {/* Right Column: AI Velocity + Engineering Rigor Visual Card */}
          <div className="lg:col-span-5 relative">
            ...
            >
              ...
              {/* Side-by-Side Balance Matrix */}
              <div className="space-y-4">
                {/* AI Layer */}
                <div className="p-4 rounded-2xl bg-[#080d11] border border-white/[0.06] relative overflow-hidden">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-xs font-bold text-[#9ae64c] flex items-center gap-2">
