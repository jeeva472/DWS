...
export function ServicesTech({ technology }: ServicesTechProps) {
  const shouldReduceMotion = useReducedMotion();

  const eyebrow = technology.eyebrow || "OUR TECH STACK";
  const title = technology.title || "Built with the right tools for the job.";
  const description =
