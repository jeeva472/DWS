...
import { AboutCTAData } from "@/lib/types/wordpress";
...
export function AboutCTA({ cta, onOpenConsultation }: AboutCTAProps) {
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="rounded-3xl glass-card border border-white/[0.12] p-8 sm:p-14 lg:p-16 text-center relative overflow-hidden shadow-2xl">
          ...
          >
            <Link
              href="/contact"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-3 px-9 py-4 rounded-full font-bold text-sm text-[#05080a] bg-gradient-to-r from-[#b4fa6c] via-[#9ae64c] to-[#78be32] hover:shadow-[0_0_35px_rgba(154,230,76,0.6)] transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]"
            >
            ...
            <button
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-8 py-4 rounded-full font-semibold text-sm text-[#9ae64c] bg-[#9ae64c]/10 border border-[#9ae64c]/30 hover:bg-[#9ae64c]/20 transition-all duration-200 cursor-pointer"
            >
